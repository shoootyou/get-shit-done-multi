...
**Note:** This is a standalone research command. For most workflows, use `{{cmdPrefix}}plan-phase` which integrates research automatically.
...
<downstream_consumer>
Your RESEARCH.md will be loaded by `{{cmdPrefix}}plan-phase` which uses specific sections:
