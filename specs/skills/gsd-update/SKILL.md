...
<execution_context>
@{{skillsPath}}/get-shit-done/VERSION
@{{skillsPath}}/get-shit-done/CHANGELOG.md
</execution_context>
...
1. Test a command to ensure everything works:
   {{#isClaude}}{{cmdPrefix}}help{{/isClaude}}{{#isCopilot}}{{cmdPrefix}}help{{/isCopilot}}{{#isCodex}}{{cmdPrefix}}help{{/isCodex}}
...
**Having issues?** Run {{cmdPrefix}}verify-installation for diagnostics.
```
</step>
