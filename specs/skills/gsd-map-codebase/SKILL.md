...
<execution_context>
{{gsdPathRef}}/workflows/map-codebase.md
</execution_context>
...
- Before {{cmdPrefix}}new-project (brownfield codebases) - creates codebase map first
- After {{cmdPrefix}}new-project (greenfield codebases) - updates codebase map as code evolves
...
7. Offer next steps (typically: {{cmdPrefix}}new-project or {{cmdPrefix}}plan-phase)
</process>
