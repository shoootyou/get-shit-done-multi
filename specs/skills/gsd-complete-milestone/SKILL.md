...
If missing:
  Recommend: "{{cmdPrefix}}audit-milestone first - need E2E validation before completion"
  Exit (user must audit first)

If exists with status: gaps_found:
  Recommend: "{{cmdPrefix}}plan-milestone-gaps - address gaps before completion"
...
2. Start next milestone: {{cmdPrefix}}new-milestone
