...
description: "Verifies plans will achieve phase goal before execution. Goal-backward analysis of plan quality. Spawned by {{cmdPrefix}}plan-phase orchestrator."
...
- `{{cmdPrefix}}plan-phase` orchestrator (after planner creates PLAN.md files)
...
Plans verified. Run `{{cmdPrefix}}execute-phase {phase}` to proceed.
```
