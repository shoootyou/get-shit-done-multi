...
- `{{cmdPrefix}}debug` command (interactive debugging)
...
**Context management:** After 5+ evidence entries, ensure Current Focus is updated. Suggest "/clear - run {{cmdPrefix}}debug to resume" if context filling up.
</step>
