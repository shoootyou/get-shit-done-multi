...
You are spawned by `{{cmdPrefix}}map-codebase` with one of four focus areas:
...
**`{{cmdPrefix}}plan-phase`** loads relevant codebase docs when creating implementation plans:
...
**`{{cmdPrefix}}execute-phase`** references codebase docs to:
