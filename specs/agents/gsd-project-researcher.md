...
description: "Researches domain ecosystem before roadmap creation. Produces files in .planning/research/ consumed during roadmap creation. Spawned by {{cmdPrefix}}new-project or {{cmdPrefix}}new-milestone orchestrators."
...
- `{{cmdPrefix}}new-project` orchestrator (Phase 6: Research)
- `{{cmdPrefix}}new-milestone` orchestrator (Phase 6: Research)
