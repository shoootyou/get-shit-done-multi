// bin/lib/updater/check-global.js
 ...
 */
export async function checkGlobalInstallations(currentVersion, verbose) {
    ...
    for (const platform of platforms) {
        const platformPath = getManifestPath(platform, true); // Set false for local
    ...
    if (!foundAny && !verbose) {
        logger.error('No global installations were found.', 2, false);
    }
}
