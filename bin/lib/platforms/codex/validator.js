...
/**
 * Codex-specific skill validator
...
/**
 * CodexValidator class
 * Validates skills for Codex CLI platform
 */
export class CodexValidator extends BaseValidator {
  /**
   * Supported platforms for this validator
   */
  static supportedPlatforms = [CODEX];

  /**
   * Create Codex validator
   */
  constructor() {
    super(CODEX);
  ...
  validateUnknownFields(frontmatter, context) {
    // Define known fields for Codex platform
    const knownFields = [
      'name',
      'description',
      'allowed-tools',
