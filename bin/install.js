...
const { detectInstalledCLIs } = require('./lib/installation/cli-detection/detect');
const { getConfigPaths } = require('./lib/configuration/paths');
const { preserveUserData, restoreUserData } = require('./lib/installation/upgrade');
const { replaceClaudePaths } = require('./lib/platforms/shared/path-rewriter');
const { getRecommendations } = require('./lib/installation/cli-detection/recommender');
const { cyan, green, yellow, dim, reset } = require('./lib/installation/colors');
const claudeAdapter = require('./lib/platforms/claude');
const copilotAdapter = require('./lib/platforms/copilot');
const codexAdapter = require('./lib/platforms/codex');
...
const { runMigration } = require('./lib/installation/migration/migration-flow');
...
const warnAndConfirmCodexLocal = require('./lib/installation/codex-warning');
