...
See `.codex/skills/get-shit-done/references/tdd.md` for TDD plan structure.
</tdd_plan_execution>
...
See .codex/skills/get-shit-done/references/checkpoints.md for complete checkpoint guidance.
</step>
...
Create `.planning/phases/XX-name/{phase}-USER-SETUP.md` using template from `.codex/skills/get-shit-done/templates/user-setup.md`.
...
Use .codex/skills/get-shit-done/templates/summary.md for structure.
...
For commit message conventions, see .codex/skills/get-shit-done/references/git-integration.md
</step>
...
**Also available:**
- `$get-shit-done verify-work {phase}-{plan}` — manual acceptance testing before continuing
...
**Also available:**
- `$get-shit-done verify-work {Z}` — manual acceptance testing before continuing
- `$get-shit-done discuss-phase {Z+1}` — gather context first
...
**Also available:**
- `$get-shit-done verify-work` — manual acceptance testing before completing milestone
- `$get-shit-done add-phase <description>` — add another phase before completing
