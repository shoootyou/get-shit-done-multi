...
**If .planning/ doesn't exist:** This is a new project - route to $get-shit-done new-project
</step>
...
📋 [N] pending todos — $get-shit-done check-todos to review
...
1. Resume interrupted agent [if interrupted agent found]
   OR
1. Execute phase ($get-shit-done execute-phase {phase})
   OR
1. Discuss Phase 3 context ($get-shit-done discuss-phase 3) [if CONTEXT.md missing]
   OR
1. Plan Phase 3 ($get-shit-done plan-phase 3) [if CONTEXT.md exists or discuss option declined]
...
- **Plan phase** → Show command for user to run after clearing:
  ...
  **Also available:**
  - `$get-shit-done discuss-phase [N]` — gather context first
  - `$get-shit-done research-phase [N]` — investigate unknowns
