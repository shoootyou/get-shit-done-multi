...
**Note:** .codex is replaced during installation with .github, .claude, or .codex depending on platform.
...
- **Template variables:** .codex replaced during installation (.github/.claude/.codex)
