...
2. **gsd-planner** — Reads CONTEXT.md to know WHAT decisions are locked
   ...
   - "AI's discretion: loading skeleton" → planner can decide approach
...
<philosophy>
**User = founder/visionary. AI = builder.**
...
Use $get-shit-done progress to see available phases.
```
Exit workflow.
...
`$get-shit-done plan-phase ${PHASE}`
...
**Also available:**
- `$get-shit-done plan-phase ${PHASE} --skip-research` — plan without research
