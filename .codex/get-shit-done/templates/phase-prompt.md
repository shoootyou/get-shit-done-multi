...
**Wave is pre-computed:** Wave numbers are assigned during `$get-shit-done plan-phase`. Execute-phase reads `wave` directly from frontmatter and groups plans by wave number. No runtime dependency analysis needed.
...
See `.codex/skills/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `.codex/skills/get-shit-done/workflows/verify-phase.md` for verification logic.
