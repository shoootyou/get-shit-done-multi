...
Exit skill and invoke SlashCommand("$get-shit-done plan-phase [X+1]")
...
**Also available:**
- `$get-shit-done discuss-phase [X+1]` — gather context first
- `$get-shit-done research-phase [X+1]` — investigate unknowns
- Review roadmap
...
Exit skill and invoke SlashCommand("$get-shit-done complete-milestone {version}")
