...
- .codex/skills/get-shit-done/references/verification-patterns.md (detection patterns)
- .codex/skills/get-shit-done/templates/verification-report.md (output format)
</required_reading>
...
See .codex/skills/get-shit-done/templates/verification-report.md for complete template.
</step>
...
1. `$get-shit-done verify-milestone` - Verify entire milestone is complete
2. `$get-shit-done archive-milestone` - Archive completed milestone for clean slate
