...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use $get-shit-done research-phase instead, which produces RESEARCH.md.
</purpose>
...
See .codex/skills/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
7. **Create DISCOVERY.md** using .codex/skills/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using .codex/skills/get-shit-done/templates/discovery.md:
...
7. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from .codex/skills/get-shit-done/templates/discovery.md
...
Use .codex/skills/get-shit-done/templates/discovery.md.
...
1. Discuss phase context ($get-shit-done discuss-phase [current-phase])
2. Create phase plan ($get-shit-done plan-phase [current-phase])
