...
- This section feeds directly into $get-shit-done plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for $get-shit-done plan-phase --gaps with root causes
...
**Creation:** When $get-shit-done verify-work starts new session
