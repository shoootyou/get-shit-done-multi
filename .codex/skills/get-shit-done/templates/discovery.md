...
For deep ecosystem research ("how do experts build this"), use `$get-shit-done research-phase` which produces RESEARCH.md.
...
- Use `$get-shit-done research-phase` for these
</guidelines>
