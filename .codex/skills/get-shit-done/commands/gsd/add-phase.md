...
- Example: `$get-shit-done add-phase Add authentication` → description = "Add authentication"
- Example: `$get-shit-done add-phase Fix critical performance issues` → description = "Fix critical performance issues"

If no arguments provided:

```
ERROR: Phase description required
Usage: $get-shit-done add-phase <description>
Example: $get-shit-done add-phase Add authentication system
```
...
2. Insert new phase heading:
   ...
   **Plans:** 0 plans
   ...
   Plans:
   - [ ] TBD (run $get-shit-done plan-phase {N} to break down)
...
**Also available:**
- `$get-shit-done add-phase <description>` — add another phase
- Review roadmap
...
- Don't use decimal numbering (that's $get-shit-done insert-phase)
- Don't create plans yet (that's $get-shit-done plan-phase)
