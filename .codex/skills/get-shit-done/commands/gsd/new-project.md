...
**After this command:** Run `$get-shit-done plan-phase 1` to start execution.
...
1. **Abort if project exists:**
   ```bash
   [ -f .planning/PROJECT.md ] && echo "ERROR: Project already initialized. Use $get-shit-done progress" && exit 1
   ```
...
- options:
  - "Map codebase first" — Run $get-shit-done map-codebase to understand existing architecture (Recommended)
  - "Skip mapping" — Proceed with project initialization

**If "Map codebase first":**
```
Run `$get-shit-done map-codebase` first, then return to `$get-shit-done new-project`
```
Exit command.
...
Use template: .codex/skills/get-shit-done/templates/research-project/STACK.md
</output>
...
Use template: .codex/skills/get-shit-done/templates/research-project/FEATURES.md
</output>
...
Use template: .codex/skills/get-shit-done/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: .codex/skills/get-shit-done/templates/research-project/PITFALLS.md
</output>
...
`$get-shit-done discuss-phase 1` — gather context and clarify approach
...
**Also available:**
- `$get-shit-done plan-phase 1` — skip discussion, plan directly
...
- [ ] User knows next step is `$get-shit-done discuss-phase 1`
