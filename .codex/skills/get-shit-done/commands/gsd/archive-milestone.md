...
Provides safety valve: archived milestones can be restored with `$get-shit-done restore-milestone`.
...
If missing files, suggest `$get-shit-done new-project` first.
...
```
$get-shit-done archive-milestone --dry-run
```

Archive with confirmation:
```
$get-shit-done archive-milestone
```

Force archive without prompt:
```
$get-shit-done archive-milestone --force
```
...
- `$get-shit-done new-milestone` - Create new milestone after archiving
- `$get-shit-done list-milestones` - View all milestones including archived
- `$get-shit-done restore-milestone` - Restore from archive (future)
