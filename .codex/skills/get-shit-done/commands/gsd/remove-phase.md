...
- Example: `$get-shit-done remove-phase 17` → phase = 17
- Example: `$get-shit-done remove-phase 16.1` → phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: $get-shit-done remove-phase <phase-number>
Example: $get-shit-done remove-phase 17
```
...
To abandon current work, use $get-shit-done pause-work instead.
```
...
Would you like to:
- `$get-shit-done progress` — see updated roadmap status
