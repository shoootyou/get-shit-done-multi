...
If missing: Display "No milestones archived yet. Archive your first milestone with $get-shit-done archive-milestone"
...
if [ ! -f .planning/MILESTONES.md ]; then
  echo "No milestones archived yet. Archive your first milestone with $get-shit-done archive-milestone"
  exit 0
fi
```
...
Restore a milestone: $get-shit-done restore-milestone [name]
```

Expected output (when no milestones):
```
No milestones archived yet. Archive your first milestone with $get-shit-done archive-milestone
```
...
- `$get-shit-done archive-milestone` - Archive a completed milestone
- `$get-shit-done restore-milestone` - Restore an archived milestone (future)
- `$get-shit-done new-milestone` - Start planning a new milestone
