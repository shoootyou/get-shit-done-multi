...
Exit skill and invoke SlashCommand("{{cmdPrefix}}plan-phase [X+1]")
...
**Also available:**
- `{{cmdPrefix}}discuss-phase [X+1]` — gather context first
- `{{cmdPrefix}}research-phase [X+1]` — investigate unknowns
- Review roadmap
...
Exit skill and invoke SlashCommand("{{cmdPrefix}}complete-milestone {version}")
