...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use {{cmdPrefix}}research-phase instead, which produces RESEARCH.md.
</purpose>
...
1. Discuss phase context ({{cmdPrefix}}discuss-phase [current-phase])
2. Create phase plan ({{cmdPrefix}}plan-phase [current-phase])
