...
**Important:** The next milestone workflow starts with `{{cmdPrefix}}new-milestone` which includes requirements definition. PROJECT.md's Validated section carries the cumulative record across milestones.
...
- [ ] User knows next step ({{cmdPrefix}}new-milestone)
