...
**If .planning/ doesn't exist:** This is a new project - route to {{cmdPrefix}}new-project
</step>
...
📋 [N] pending todos — {{cmdPrefix}}check-todos to review
...
1. Resume interrupted agent [if interrupted agent found]
   OR
1. Execute phase ({{cmdPrefix}}execute-phase {phase})
   OR
1. Discuss Phase 3 context ({{cmdPrefix}}discuss-phase 3) [if CONTEXT.md missing]
   OR
1. Plan Phase 3 ({{cmdPrefix}}plan-phase 3) [if CONTEXT.md exists or discuss option declined]
...
- **Plan phase** → Show command for user to run after clearing:
  ...
  **Phase [N]: [Name]** — [Goal from ROADMAP.md]
  ...
  `{{cmdPrefix}}plan-phase [phase-number]`
  ...
  **Also available:**
  - `{{cmdPrefix}}discuss-phase [N]` — gather context first
  - `{{cmdPrefix}}research-phase [N]` — investigate unknowns
