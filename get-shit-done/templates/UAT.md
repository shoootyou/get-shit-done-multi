...
- This section feeds directly into {{cmdPrefix}}plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for {{cmdPrefix}}plan-phase --gaps with root causes
...
**Creation:** When {{cmdPrefix}}verify-work starts new session
