...
**Plans:**
- [ ] 02-01-PLAN.md — Core flag parsing infrastructure (three-stage architecture)
- [ ] 02-02-PLAN.md — Codex global warning & edge cases
- [ ] 02-03-PLAN.md — Flag system test suite
...
4. Non-TTY environment detected, falls back to "install all locally" with message
