...
- Show error message: "Flag '{flag}' has been removed in v1.10.0."
- Include example of new syntax: "Use '--claude --local' instead of '--local'"
- Provide link to migration guide: "See MIGRATION.md for details"
...
- Fallback to sensible default: Install all platforms locally
- Show message: "Non-interactive environment detected. Installing all platforms locally."
- Priority: P0
...
- Focus only on `--local`/`--global` → platform flags transition
- Provide clear before/after examples
- No complex scenarios, keep it simple
- Priority: P0
