...
### Pending Todos
1. [Optimize warning display order - collect all warnings in single block](.planning/todos/pending/2026-01-27-optimize-warning-display-order.md) — Area: tooling
