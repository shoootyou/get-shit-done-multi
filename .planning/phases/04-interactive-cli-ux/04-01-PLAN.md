...
must_haves:
  ...
  wiring:
    - bin/install.js imports runInteractive from bin/lib/cli/interactive.js
    - interactive.js imports detectBinaries from binary-detector.js
    - interactive.js imports adapterRegistry from registry.js
    - interactive.js imports install from orchestrator.js
    - interactive.js imports createMultiBar from progress.js
    - interactive.js imports logger from logger.js
  key_links:
    - bin/install.js TTY check determines interactive vs CLI mode
    - interactive.js global detection check prevents all-disabled menu
    - interactive.js passes selected platforms to orchestrator reusing existing install logic
---
