...
1. **Import dependencies:**
   ...
   - detectCLI from ../cli-detection/detect.js (Phase 3)
...
3. **CLI-specific adapter loading:**
   ...
   - Call adapter.invokeAgent(agent, prompt, options) if method exists
   - If adapter doesn't have invokeAgent method, return placeholder: `{ success: true, message: 'Agent invocation not yet implemented in adapter', agent: agentName, cli }`
