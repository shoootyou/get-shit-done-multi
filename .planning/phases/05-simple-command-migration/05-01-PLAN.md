...
changelog:
  - date: 2025-01-23
    change: "Added gsd-whats-new command (blocker fix)"
    reason: "Plan-checker found command count mismatch (20 vs 21). Added missing gsd-whats-new (Tier 1 reference-only, 124 lines) to complete Phase 5 coverage."
must_haves:
