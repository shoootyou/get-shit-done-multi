...
**Wave 1 (Plans 01-02):**
- gsd-help, gsd-verify-installation, gsd-list-milestones (Plan 01)
- gsd-whats-new, gsd-list-phase-assumptions, gsd-resume-work (Plan 02)
...
- 6 commands: help, verify-installation, list-milestones, whats-new, list-phase-assumptions, resume-work
- Pattern: Display info, no side effects
- Risk: LOW (simple read operations)
...
1. Reference commands (6) - display info
2. Phase management (3) - manipulate roadmap
3. Todo management (2) - create/check todos
4. Verification suite (2) - UAT testing, discussion
5. Milestone lifecycle (5) - complete/audit/archive flow
6. Progress hub (1) - route to 11 commands
  </what-built>
