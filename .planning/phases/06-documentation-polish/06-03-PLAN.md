...
must_haves:
  ...
  required_artifacts:
    ...
    - "README.md references ARCHITECTURE.md, CONTRIBUTING.md, MIGRATION-V2.md"
...
Focus changes on v2.0 architecture and documentation references.
  ...
  <verify>
    <command>grep -q "What's New in v2.0" README.md && grep -q "ARCHITECTURE.md" README.md && grep -q "CONTRIBUTING.md" README.md && grep -q "MIGRATION-V2.md" README.md</command>
    <expected>README.md has v2.0 section and documentation references</expected>
  </verify>
...
3. ✅ README.md references ARCHITECTURE.md, CONTRIBUTING.md, MIGRATION-V2.md
