...
@.claude/get-shit-done/CHANGELOG.md
</execution_context>
...
if [ -f "./.claude/get-shit-done/.gsd-install-manifest.json" ]; then
  MANIFEST_FILE="./.claude/get-shit-done/.gsd-install-manifest.json"
  SCOPE="local"
elif [ -f "${HOME}/.claude/get-shit-done/.gsd-install-manifest.json" ]; then
  MANIFEST_FILE="${HOME}/.claude/get-shit-done/.gsd-install-manifest.json"
  SCOPE="global"
else
  echo "Error: GSD installation not found"
  echo "No manifest file at .claude/get-shit-done/.gsd-install-manifest.json"
  echo ""
  echo "Run installation first: npx get-shit-done-multi --claude"
  exit 1
fi
