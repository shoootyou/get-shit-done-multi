...
**Note:** .claude is replaced during installation with .github, .claude, or .codex depending on platform.
...
- **Template variables:** .claude replaced during installation (.github/.claude/.codex)
