...
- This section feeds directly into /{{COMMAND_PREFIX}}plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /{{COMMAND_PREFIX}}plan-phase --gaps with root causes
...
**Creation:** When /{{COMMAND_PREFIX}}verify-work starts new session
