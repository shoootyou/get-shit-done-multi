...
**Note:** {{PLATFORM_ROOT}} is replaced during installation with .github, .claude, or .codex depending on platform.
...
- **Template variables:** {{PLATFORM_ROOT}} replaced during installation (.github/.claude/.codex)
