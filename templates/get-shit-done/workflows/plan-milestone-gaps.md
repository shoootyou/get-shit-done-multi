...
PHASES=$(node {{PLATFORM_ROOT}}/get-shit-done/bin/gsd-tools.js phases list)
...
```bash
node {{PLATFORM_ROOT}}/get-shit-done/bin/gsd-tools.js commit "docs(roadmap): add gap closure phases {N}-{M}" --files .planning/ROADMAP.md
```
