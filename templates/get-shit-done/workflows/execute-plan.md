...
Use {{PLATFORM_ROOT}}/get-shit-done/templates/summary.md for structure.
...
For commit message conventions, see {{PLATFORM_ROOT}}/get-shit-done/references/git-integration.md
</step>
