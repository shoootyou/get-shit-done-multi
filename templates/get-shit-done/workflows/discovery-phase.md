...
See {{PLATFORM_ROOT}}/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
7. **Create DISCOVERY.md** using {{PLATFORM_ROOT}}/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using {{PLATFORM_ROOT}}/get-shit-done/templates/discovery.md:
...
7. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from {{PLATFORM_ROOT}}/get-shit-done/templates/discovery.md
...
Use {{PLATFORM_ROOT}}/get-shit-done/templates/discovery.md.
