...
for plan in "$PHASE_DIR"/*-PLAN.md; do
  echo "=== $plan ==="
  PLAN_STRUCTURE=$(node {{PLATFORM_ROOT}}/get-shit-done/bin/gsd-tools.js verify plan-structure "$plan")
  echo "$PLAN_STRUCTURE"
done
```
...
```bash
MUST_HAVES=$(node {{PLATFORM_ROOT}}/get-shit-done/bin/gsd-tools.js frontmatter get "$PLAN_PATH" --field must_haves)
```
...
```bash
PLAN_STRUCTURE=$(node {{PLATFORM_ROOT}}/get-shit-done/bin/gsd-tools.js verify plan-structure "$PLAN_PATH")
```
