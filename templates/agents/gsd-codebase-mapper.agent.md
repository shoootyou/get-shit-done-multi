...
You are spawned by `{{COMMAND_PREFIX}}map-codebase` with one of four focus areas:
...
**`{{COMMAND_PREFIX}}plan-phase`** loads relevant codebase docs when creating implementation plans:
