...
description: >-
  Mark milestone complete, archive to milestones/, update PROJECT and MILESTONES
  registry
...
If missing:
  Recommend: "{{COMMAND_PREFIX}}audit-milestone first - need E2E validation before completion"
  Exit (user must audit first)

If exists with status: gaps_found:
  Recommend: "{{COMMAND_PREFIX}}plan-milestone-gaps - address gaps before completion"
...
2. Start next milestone: {{COMMAND_PREFIX}}new-milestone
