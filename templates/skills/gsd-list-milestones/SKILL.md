...
If missing: Display "No milestones archived yet. Archive your first milestone with {{COMMAND_PREFIX}}archive-milestone"
...
if [ ! -f .planning/MILESTONES.md ]; then
  echo "No milestones archived yet. Archive your first milestone with {{COMMAND_PREFIX}}archive-milestone"
  exit 0
fi
```
...
Restore a milestone: {{COMMAND_PREFIX}}restore-milestone [name]
```

Expected output (when no milestones):
```
No milestones archived yet. Archive your first milestone with {{COMMAND_PREFIX}}archive-milestone
```
...
- `{{COMMAND_PREFIX}}archive-milestone` - Archive a completed milestone
- `{{COMMAND_PREFIX}}restore-milestone` - Restore an archived milestone (future)
- `{{COMMAND_PREFIX}}new-milestone` - Start planning a new milestone
