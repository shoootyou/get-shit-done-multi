...
1. Execute gap closure phases: {{COMMAND_PREFIX}}progress (will route to execution)
2. After gaps fixed: {{COMMAND_PREFIX}}audit-milestone {version} (re-audit)
3. If audit passes: {{COMMAND_PREFIX}}complete-milestone {version}
