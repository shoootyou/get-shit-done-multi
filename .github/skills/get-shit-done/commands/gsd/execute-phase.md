...
@.github/skills/get-shit-done/workflows/execute-phase.md
</execution_context>
...
See `@.github/skills/get-shit-done/workflows/execute-phase.md` step `checkpoint_handling` for complete details.
</checkpoint_handling>
